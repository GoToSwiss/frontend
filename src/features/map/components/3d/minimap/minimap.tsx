...
// function MiniMap({ camera3dProps, onMapClick }: MiniMapProps) {
//   const minimap = useMap('minimap');

//   const cameraPosition = useMemo(() => estimateCameraPosition(camera3dProps), [camera3dProps]);
...
//       const maxZoom = Math.max(1, Math.round(24 - Math.log2(camera3dProps.range)));
